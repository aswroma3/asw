...
echo Starting Sentence Service [*1, listening on 8080, delay=150]

java -Xms64m -Xmx128m -jar -Dasw.sentence.sentenceservice.instancename=S -Dasw.sentence.sentenceservice.delay=150 sentence-service/build/libs/sentence.jar &

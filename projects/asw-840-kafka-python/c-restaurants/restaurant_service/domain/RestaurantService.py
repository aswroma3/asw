...
class RestaurantService: 
    def __init__(self, restaurant_event_publisher): 
        self.restaurant_event_publisher = restaurant_event_publisher 
        self.restaurants = {} 
    ...
    def create_restaurant(self, name: str, location: str):
        ...
        # ora crea e pubblica l'evento di creazione del ristorante 
        event = RestaurantCreatedEvent(id=restaurant.rid, name=restaurant.name, location=restaurant.location)
        self.restaurant_event_publisher.publish(event, restaurant_created_event_type)
        return restaurant 

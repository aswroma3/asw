...
sudo nerdctl --namespace k8s.io image rm aswroma3/sentence-sentence-kube-dns:${VERSION}
sudo nerdctl --namespace k8s.io image rm aswroma3/sentence-sentence-async-kube-dns:${VERSION}
sudo nerdctl --namespace k8s.io image rm aswroma3/sentence-word-kube-dns:${VERSION}
sudo nerdctl --namespace k8s.io image rm aswroma3/sentence-apigateway-kube-dns:${VERSION}
